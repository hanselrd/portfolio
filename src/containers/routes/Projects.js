          ...
          <Card.Group itemsPerRow={2} stackable>
            ...
            >
              <Card.Content>
                ...
                <Card.Description>
                  ...
                  employers and others to see my work and get in contact with
                  me. At first I had the idea of creating my own blog but I
            ...
            >
              <Card.Content>
                ...
                <Card.Description>
                  ...
                  <em>America East Hackathon 2017</em> in under 24 hours by
                  myself alongside three other collaborators. We created a
                  simple web-based tool that could be used to upload your energy
                  bill or manually enter data to provide consumers with
                  effective tips on how to save on their energy bills. We used
                  Google Assist to provide a personal energy auditor that can
                  safely be activated from your computer or mobile device. We
                  won best beginner hack as it was our first{' '}
            ...
            >
              <Card.Content>
                ...
                <Card.Description>
                  This project was developed by myself alongside two of my
                  peers. I served as team leader and we used agile development
                  to organize meetings and plan sprints. We developed a game in{' '}
                  <em>C++</em> that dynamically loads in maps using{' '}
                  <em>Tiled</em>'s <em>.tmx</em> format and uses <em>Python</em>{' '}
                  as its scripting language to create a simple API for creating
                  NPCs.
                </Card.Description>
              </Card.Content>
            </Card>
