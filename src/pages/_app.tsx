...
import { DEV, NEXT_PUBLIC_URL, NODE_ENV } from "@/core/environment";
  ...
  return (
    <>
      ...
      <DefaultSeo
        ...
        openGraph={{
          ...
          locale: router.locale
            ? `${router.locale.split("-")[0]}_${router.locale.split("-")[1].toUpperCase()}`
            : "en_US",
          images: [
            {
      ...
      <div className="flex flex-col min-h-screen">
        <Header />
        <main className="container flex-1 mt-20 mx-auto p-6 break-all prose prose-sm dark:prose-dark md:prose">
